...
* **[Transfermarkt Dataset](https://www.kaggle.com/datasets/davidcariboo/player-scores):** Contains the transfer fees (which serve as our target variable), player demographic data (age, nationality, contract information), minutes played, and basic performance statistics.
...
* The data is normalised using a mapping system designed to account for performance in more difficult leagues, ultimately aiming to accurately predict intrinsic value. 
...
* `raw_train & raw_test`: The base preprocessed dataset.
